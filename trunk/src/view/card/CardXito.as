package view.card 
{
	 ...
	 * @author Yun
	 */
	public class CardXito extends Sprite 
	{
		...
		public var filterNumber:Number = 0;
		private var isFilterDown:Boolean;
		private var bitmap:Bitmap;
		public var isMine:Boolean;
		public var cardBorder:Sprite;
		public var overLayer:Sprite;
		public var redBorder:Sprite;
		
		public function CardXito(_size:Number = 1)
		{
			size = _size;
			
			scaleX = scaleY = size;
			
			addContent("zCardXito");
		...
		public function moveDown(size:Number):void
		{
			...
			point.y = startY;
			point = parent.localToGlobal(point);
			moving(point, CardManagerXito.clickCardTime, CardManagerXito.TURN_OVER_STYLE, size, 0, false, false, false);
		}
