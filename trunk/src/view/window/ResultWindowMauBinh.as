package view.window 
{
	 ...
	 * @author Yun
	 */
	public class ResultWindowMauBinh extends BaseWindow 
	{
		...
		public function ResultWindowMauBinh() 
		{
			addContent("zResultWindowMauBinh");
			addButton();
			resetInfo();
		}
		...
		public function setInfo(playerList:Array):void
		{
			...
			playerList.sortOn(DataFieldMauBinh.TOTAL, Array.NUMERIC);
			playerList.reverse();
			var myIndex:int;
