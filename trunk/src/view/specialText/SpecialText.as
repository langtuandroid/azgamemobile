package view.specialText 
{
	 ...
	 * @author ZhaoYun
	 */
	public class SpecialText extends Sprite
	{
		private var bitmap:Bitmap;
		private var textSize:int;
		
		public function SpecialText(ts:int = 18) 
		{
			bitmap = new Bitmap();
			textSize = ts;
		}
		...
		public function setText(content:String):void
		{
			...
			tempTextfield.defaultTextFormat = new TextFormat("TimesNewRoman", textSize, 0xFFFFFF, true);
