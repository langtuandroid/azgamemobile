package control 
{
	...
	{	
		...
		{
			trace("connect tới server binh: ", e.successful)
			...
			switch (command) 
			{
				case Command.GET_PLAYING_INFO: // lấy thông tin của các người chơi trong phòng chơi
					...
					for (i = 0; i < tempUserList.length; i++) 
					{
						...
						object[DataFieldMauBinh.DEVICE_ID] = 'none';
						if (user.userVariableByName(DataFieldMauBinh.USER_INFO).value.doesPropertyExist(DataFieldMauBinh.DEVICE_ID))
							object[DataFieldMauBinh.DEVICE_ID] = user.userVariableByName(DataFieldMauBinh.USER_INFO).value.getString(DataFieldMauBinh.DEVICE_ID);
						...
						object[DataFieldMauBinh.WIN] = user.userVariableByName(DataFieldMauBinh.USER_INFO).value.getInteger(DataFieldMauBinh.WIN);
						object[DataFieldMauBinh.LOSE] = user.userVariableByName(DataFieldMauBinh.USER_INFO).value.getInteger(DataFieldMauBinh.LOSE);
