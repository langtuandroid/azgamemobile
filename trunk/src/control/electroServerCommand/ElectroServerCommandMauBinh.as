package control.electroServerCommand 
{
	...
	public class ElectroServerCommandMauBinh 
	{
		...
		public function ElectroServerCommandMauBinh() 
		{
		...
		{
			mainData.publicChatData.userName = e.data[DataFieldMauBinh.USER_NAME];
			mainData.publicChatData.displayName = e.data[DataFieldMauBinh.DISPLAY_NAME];
			mainData.publicChatData.chatContent = e.data[DataFieldMauBinh.CHAT_CONTENT];
		...
		private function onServerConfirmAddFriendInvite(e:ElectroServerEvent):void 
		{
			...
			var invitedNameArray:Array = [e.data[DataFieldMauBinh.FRIEND_ID]];
		...
		private function onServerConfirmAddFriendConfirm(e:ElectroServerEvent):void 
		{
			...
			esObject.setString(DataFieldMauBinh.USER_NAME, mainData.chooseChannelData.myInfo.uId);
			esObject.setString(DataFieldMauBinh.MESSAGE, mess);
			esObject.setBoolean(DataFieldMauBinh.SUCCESS, e.data[DataFieldMauBinh.SUCCESS]);
		...
		{
			if (!infoObject[DataFieldMauBinh.ROOM_PASSWORD])
				infoObject[DataFieldMauBinh.ROOM_PASSWORD] = "";
		...
		private function onRemoveFriend(e:ElectroServerEvent):void 
		{
			if(coreAPI.myData.friendList)
				delete coreAPI.myData.friendList[e.data[DataFieldMauBinh.USER_NAME]];
		...
		private function onFriendConfirmAddFriendInvite(e:ElectroServerEvent):void 
		{
			...
			if (coreAPI.myData.friendList)
			{
				...
				{
					coreAPI.myData.friendList[e.data[DataFieldMauBinh.USER_NAME]] = new Object();
					coreAPI.myData.friendList[e.data[DataFieldMauBinh.USER_NAME]][DataFieldMauBinh.DISPLAY_NAME] = e.data[DataFieldMauBinh.DISPLAY_NAME];
				}
			}
		}
