package view.window.shop 
{
	 ...
	 * @author bimkute
	 */
	public class ContentItemPurchase extends MovieClip 
	{
		private var content:MovieClip;
		public var _idAvt:String;
		public var _goldAvt:String;
		public var _chipAvt:String;
		public function ContentItemPurchase() 
		{
			super();
			content = new ContentPurchaseMc();
			addChild(content);
		...
		private function onAddToStage(e:Event):void 
		{
			...
			content.buyPurchaseBtn.addEventListener(MouseEvent.MOUSE_UP, onBuyAvatar);
		...
		private function onRemoveFromStage(e:Event):void 
		{
			...
			content.buyPurchaseBtn.removeEventListener(MouseEvent.MOUSE_UP, onBuyAvatar);
