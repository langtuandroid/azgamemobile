...
public class StoreKitExample extends Sprite
{
	...
	{		
		...
		productIdList.push("15KVNDIPHONE");
		productIdList.push("42KVNDIPHONE");
		productIdList.push("70KVNDIPHONE");
		productIdList.push("140KVNDIPHONE");
		productIdList.push("700KVNDIPHONE");	
	}
	
	public function loadProductDetails(pList:Vector.<String>):void
	{
		...
		StoreKit.storeKit.loadProductDetails(pList);
	}
	...
	public function purchaseProduct(productId:String):void
	{
		...
		log("start purchase of consumable  '"+SPELL_PRODUCT_ID+"'...");
		// the second parameter is quantity.  its possible to purchase more than 1 if you want.
		StoreKit.storeKit.purchaseProduct(productId, 1);
	}
	...
	private function onProductsLoaded(e:StoreKitEvent):void
	{
		...
		mainData.isLoadInAppProductListComplete = true;
	...
	{
		log("Successful purchase of '"+e.receipt+"'");
