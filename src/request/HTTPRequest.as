package request 
{
	...
	public class HTTPRequest extends EventDispatcher
	{
		 ...
		 */
		public function sendRequest(method:String, url:String, _value:Object, _completeFunction:Function, _isDecode:Boolean = false, timeOut:int = 10, dataFormat:String = "text"):void
		{
			isDecode = _isDecode;
