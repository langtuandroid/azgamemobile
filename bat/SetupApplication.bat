...
:: Android packaging
set AND_CERT_NAME="PhomMobile"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\PhomMobile.p12
...
set IOS_PROVISION=cert\PhomMobile.mobileprovision
...
set APP_ID=air.BoGameBaiCiaoMobile

:: Output packages
set DIST_PATH=dist
set DIST_NAME=BoGameBaiCiaoMobile
